    ...
    <div className="app-wrapper" style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: 'var(--bg-light)' }}>
      ...
      <header style={{ backgroundColor: 'var(--bg-light)', borderBottom: '1px solid var(--color-border-light)', position: 'sticky', top: 0, zIndex: 100 }} className="no-print">
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '90px' }}>
          ...
          <Link to="/" style={{ display: 'flex', alignItems: 'center', height: '100%', padding: '5px 0' }}>
            <img src="/logo.png" alt="JMD Global Stones Logo" style={{ height: '70px', objectFit: 'contain', mixBlendMode: 'multiply', display: 'block' }} />
          </Link>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 0.8fr 1.2fr 1.5fr', gap: '2rem' }} className="footer-grid">
            ...
            <div>
              ...
              <h5 style={{ color: '#fff', fontSize: '1rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.75rem' }}>JMD GLOBAL STONES PVT LTD</h5>
              <p style={{ fontSize: '0.92rem', lineHeight: 1.65, color: 'rgba(255, 255, 255, 0.65)', margin: 0 }}>
                UK Supplier of Indian Sandstone, Porcelain, Limestone Patio Slabs with Kerbside Delivery.
              </p>
            </div>

            {/* Col 2: Menu */}
            <div>
              <h4 style={{ color: '#fff', fontSize: '1.05rem', fontWeight: 700, marginBottom: '1.5rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                Menu
              </h4>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.85rem', fontSize: '0.98rem' }}>
                <li><Link to="/" style={{ color: 'rgba(255, 255, 255, 0.85)', textDecoration: 'none' }} className="nav-hover-gold">Home</Link></li>
                <li><Link to="/products" style={{ color: 'rgba(255, 255, 255, 0.85)', textDecoration: 'none' }} className="nav-hover-gold">Products</Link></li>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', fontSize: '0.98rem' }}>
                <div>
                  <p style={{ color: 'rgba(255, 255, 255, 0.45)', fontSize: '0.82rem', textTransform: 'uppercase', letterSpacing: '0.05em', margin: '0 0 0.25rem' }}>Company Number</p>
                  <p style={{ color: '#fff', fontWeight: 600, margin: 0 }}>12807959</p>
                </div>
                <div>
                  <p style={{ color: 'rgba(255, 255, 255, 0.45)', fontSize: '0.82rem', textTransform: 'uppercase', letterSpacing: '0.05em', margin: '0 0 0.25rem' }}>VAT Number</p>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem', fontSize: '0.98rem', color: 'rgba(255, 255, 255, 0.85)' }}>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', marginTop: '2rem', paddingTop: '1.25rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.88rem', color: 'rgba(255,255,255,0.45)' }} className="footer-bottom">
