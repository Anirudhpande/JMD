            ...
            <div>
              {checkoutStep === 'cart' ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', marginTop: '1rem' }} className="basket-actions-row">
                    <button onClick={clearCart} className="btn btn-secondary checkout-btn-mobile" style={{ height: '54px', padding: '0 1.5rem', fontSize: '0.8rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
                      Clear Basket
                    </button>
                    <button 
                      onClick={() => {
                      ...
                      className="btn btn-primary checkout-btn-mobile" 
                      style={{ height: '54px', padding: '0 2.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', fontSize: '0.85rem', fontWeight: 700, letterSpacing: '0.08em' }}
                    >
                ...
                <div style={{ border: '1px solid var(--color-border-light)', padding: '3rem 2.5rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '0.5rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                      <button 
                        ...
                        style={{ border: '1px solid var(--color-border-light)', height: '54px', cursor: 'pointer', backgroundColor: paymentMethod === 'stripe' ? 'var(--text-on-light)' : '#FFFFFF', color: paymentMethod === 'stripe' ? 'var(--bg-light)' : 'var(--text-on-light)', fontSize: '0.82rem', fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase', borderRadius: '4px', transition: 'all 0.15s ease' }}
                      >
                        Credit Card
                      </button>
                      <button 
                        ...
                        className="payment-option-btn"
                        style={{ border: '1px solid var(--color-border-light)', height: '54px', cursor: 'pointer', backgroundColor: paymentMethod === 'bank_transfer' ? 'var(--text-on-light)' : '#FFFFFF', color: paymentMethod === 'bank_transfer' ? 'var(--bg-light)' : 'var(--text-on-light)', fontSize: '0.82rem', fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase', borderRadius: '4px', transition: 'all 0.15s ease' }}
                      >
                        Bank Transfer
                      </button>
                    </div>
                  ...
                  <button type="button" onClick={() => setCheckoutStep('cart')} className="btn btn-secondary checkout-btn-mobile" style={{ width: '100%', height: '56px', fontSize: '0.85rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em', borderRadius: '4px' }}>
                    Back to Basket
                  </button>
                </div>
              )}
            ...
            <div>
              <div style={{ border: '1px solid var(--color-border-light)', padding: '2.5rem 2rem', backgroundColor: 'transparent', height: 'fit-content' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2rem' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem' }}>
                    <span style={{ color: 'var(--text-muted-on-light)' }}>Delivery charges</span>
