...
const blogPosts = [
  ...
  },
  {
    ...
    readTime: "6 min read",
    image: "/images/Country_Anthracite.jpg",
    content: (
      <div>
    ...
    <div style={{ backgroundColor: 'var(--bg-light)', padding: '1.25rem 0 2rem 0', minHeight: 'calc(100vh - 90px)' }}>
      <div className="container" style={{ width: '100%' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '1rem' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', color: 'var(--color-accent)', marginBottom: '0.35rem' }}>
            <BookOpen size={14} />
            <span style={{ textTransform: 'uppercase', fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.12em' }}>JMD Knowledge Base</span>
          </div>
          <h1 style={{ fontSize: '2rem', fontFamily: 'var(--font-heading)', marginTop: '0.15rem', marginBottom: '0.35rem', fontWeight: 400, lineHeight: 1.15 }}>
        ...
        {/* Blog Post Grid - Compact 4 Columns */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1.25rem' }} className="blog-grid">
          {blogPosts.map((post, idx) => (
            <article key={idx} style={{ backgroundColor: '#FFFFFF', border: '1px solid var(--color-border-light)', display: 'flex', flexDirection: 'column', borderRadius: '4px', overflow: 'hidden', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
              <div style={{ height: '135px', overflow: 'hidden', position: 'relative' }}>
                <img 
                  ...
                  loading="lazy"
                />
                <span style={{ position: 'absolute', top: '0.6rem', left: '0.6rem', backgroundColor: 'var(--bg-dark)', color: 'var(--text-on-dark)', padding: '0.25rem 0.6rem', fontSize: '0.58rem', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 700, borderRadius: '2px' }}>
                  {post.category}
                </span>
              </div>
              <div style={{ padding: '1.25rem', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                ...
                {/* Meta */}
                <div style={{ display: 'flex', gap: '0.6rem', fontSize: '0.68rem', color: 'var(--text-muted-on-light)', marginBottom: '0.6rem', alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.1rem', fontWeight: 600, lineHeight: 1.3, marginBottom: '0.5rem', color: '#111', height: '2.8rem', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
                  {post.title}
                </h2>

                <p style={{ color: 'var(--text-muted-on-light)', fontSize: '0.8rem', lineHeight: 1.45, marginBottom: '1.25rem', flexGrow: 1, display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'hidden', height: '3.5rem' }}>
                  {post.excerpt}
                </p>
                ...
                <div>
                  <button 
                    ...
                    style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '0.4rem', fontSize: '0.72rem', padding: '0 1rem', height: '36px', letterSpacing: '0.05em', cursor: 'pointer', border: '1px solid var(--color-border-light)', borderRadius: '20px', width: '100%' }}
                  >
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {/* Title */}
              <h1 style={{ fontFamily: 'var(--font-heading)', fontSize: '2.2rem', fontWeight: 400, color: 'var(--text-on-light)', lineHeight: 1.25, marginBottom: '1.5rem' }}>
                {readingPost.title}
              </h1>

              {/* Banner Image */}
              <div style={{ height: '300px', width: '100%', marginBottom: '2rem', overflow: 'hidden', border: '1px solid #D9D2C5' }}>
              ...
              {/* Author footer */}
              <div style={{ marginTop: '3rem', padding: '1.5rem', borderTop: '1px solid #D9D2C5', display: 'flex', gap: '1.5rem', alignItems: 'center', backgroundColor: '#EBE4D9' }}>
      ...
      <style>{`
        ...
        @media (max-width: 1024px) {
          .blog-grid { grid-template-columns: repeat(2, 1fr) !important; gap: 1.25rem !important; }
        }
